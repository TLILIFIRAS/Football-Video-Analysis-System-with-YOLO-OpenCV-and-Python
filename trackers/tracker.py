...
class Tracker :
    ...
    def interpolate_ball_positions(self,ball_positions):
        ...
        df_ball_positions = df_ball_positions.bfill() # for the first frames
        ...
        for frame_num,frame in enumerate(video_frames):
            ...
            for track_id, player in player_dict.items():
                ...
                if player.get("has_ball",False):
                    frame = self.draw_traingle(frame,player["bbox"],(123,0,255))
            
            
            
            #drawing referees
            for _, referee in referee_dict.items():
                frame = self.draw_elipse(frame,referee["bbox"],(0,0,255))
            # Draw ball 
